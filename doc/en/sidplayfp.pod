...
=item Left/Right Arrows, 'j'/'l' keys
...
Jump to a tune by specifying its index number.
...
The upstream bug tracker can be found at L<https://github.com/red-M95/sidplayfp-red_M95/issues/>.
...
=head1 Authors of this fork

=over

=item red M95

The entire development, pretty much.

=item frozen

Helping red M95 to fix her beginner mistakes.
